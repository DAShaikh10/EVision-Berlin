...
def test_initialization(mock_postal_code):
    ...
    event = StationSearchPerformedEvent(postal_code=mock_postal_code, stations_found=stations_count)
...
def test_initialization_with_parameters(mock_postal_code):
    ...
    event = StationSearchPerformedEvent(postal_code=mock_postal_code, stations_found=5, search_parameters=params)
...
def test_immutability(mock_postal_code):
    ...
    """
    event = StationSearchPerformedEvent(postal_code=mock_postal_code, stations_found=5)
